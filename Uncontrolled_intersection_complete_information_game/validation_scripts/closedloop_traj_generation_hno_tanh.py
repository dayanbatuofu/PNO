...
if __name__ == '__main__':
    ...
    if save_data:
        save_path = 'closed_loop/tanh/closedloop_traj_hno_initial_' + str(policy[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_hno_initial_' + str(policy[N_choice]) + '_tanh_nc.mat'
