...
if __name__ == '__main__':
    ...
    if save_data:
        save_path = 'closed_loop/tanh/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_tanh.mat'
        # save_path = 'closed_loop/tanh/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_tanh_nc.mat'
