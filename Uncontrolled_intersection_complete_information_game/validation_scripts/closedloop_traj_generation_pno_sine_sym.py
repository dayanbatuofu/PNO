...
if __name__ == '__main__':
    ...
    ckpt_path = './model/tanh/model_pno_sin.pth'
    activation = 'sine'
    ...
    if save_data:
        save_path = 'closed_loop/sine/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_sine_nc.mat'
