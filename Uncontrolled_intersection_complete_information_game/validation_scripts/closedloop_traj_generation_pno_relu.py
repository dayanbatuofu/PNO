...
if __name__ == '__main__':
    ...
    if save_data:
        save_path = 'closed_loop/relu/closedloop_traj_pno_' + str(policy[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_pno_initial_' + str(policy[N_choice]) + '_relu_nc.mat'
