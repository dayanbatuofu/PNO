...
if __name__ == '__main__':
    ...
    if save_data:
        save_path = 'closed_loop/sine/closedloop_traj_pno_initial_' + str(policy[N_choice]) + '_sine.mat'
        # save_path = 'closed_loop/sine/closedloop_traj_pno_initial_' + str(policy[N_choice]) + '_sine_nc.mat'
