...
if __name__ == '__main__':
    ...
    ckpt_path = './model/relu/model_pno_relu.pth'
    activation = 'relu'
    ...
    if save_data:
        save_path = 'closed_loop/relu/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_relu.mat'
        # save_path = 'closed_loop/relu/closedloop_traj_pno_initial_' + str(policy1[N_choice]) + '_relu_nc.mat'
